  ...
  return (
    <div className="max-w-2xl h-[calc(100vh-120px)] flex flex-col">
              ...
              <div className={`flex ${isOwn ? 'justify-end' : 'justify-start'} mb-1`}>
                <div className={`max-w-[75%] ${
                  isOwn
                    ...
                    : 'backdrop-blur-xl bg-white/30 border border-white/40 rounded-2xl rounded-bl-md'
                } px-4 py-2.5`}>
                  {isFromPractice && (
      ...
      <form onSubmit={handleSend} className="shrink-0 flex gap-2 items-end">
        <div className="flex-1 backdrop-blur-xl bg-white/30 rounded-xl border border-white/40 flex items-end">
          <textarea
            value={newMsg}
