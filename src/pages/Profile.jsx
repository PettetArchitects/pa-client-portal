  ...
  if (loading) {
    return (
      <div className="max-w-lg animate-pulse">
        <div className="h-6 w-24 bg-white/40 rounded mb-2" />
        <div className="h-4 w-64 bg-white/40 rounded mb-8" />
        <div className="h-4 w-16 bg-white/40 rounded mb-4" />
        <div className="space-y-4">
          {[1, 2, 3].map(i => (
            <div key={i}>
              <div className="h-3 w-20 bg-white/40 rounded mb-1.5" />
              <div className="h-10 bg-white/40 rounded-lg" />
            </div>
          ))}
        </div>
        <div className="h-10 w-32 bg-white/40 rounded-lg mt-4" />
        <div className="border-t border-[var(--color-border)] pt-8 mt-10">
          <div className="h-4 w-32 bg-white/40 rounded mb-4" />
          {[1, 2].map(i => (
            <div key={i} className="mb-4">
              <div className="h-3 w-28 bg-white/40 rounded mb-1.5" />
              <div className="h-10 bg-white/40 rounded-lg" />
            </div>
          ))}
        </div>
